...
> = {
  flight: {
    ...
    icon: "✈️",
    color: "agent-flight",
    description: "Live web scraping and fare analysis",
  },
  lodging: {
    name: "Lodging Agent",
    icon: "🏨",
    color: "agent-lodging",
    description: "Rule-based lodging cost calculation",
  },
  transport: {
    name: "Transport Agent",
    icon: "🚌",
    color: "agent-transport",
    description: "Rule-based transit and parking costs",
  },
  attractions: {
    name: "Attractions Agent",
    icon: "🎭",
    color: "agent-attractions",
    description: "Rule-based activity pricing",
  },
  savings: {
    name: "Savings Agent",
    icon: "💰",
    color: "agent-savings",
    description: "Membership and promo discount rules",
  },
  group: {
    name: "Group Agent",
    icon: "👥",
    color: "agent-group",
    description: "Group rate tables and cost splitting",
  },
  routing: {
    name: "Routing Agent",
    icon: "🗺️",
    color: "agent-routing",
    description: "Neighborhood route sequencing rules",
  },
  budget: {
    name: "Budget Agent",
    icon: "📊",
    color: "agent-budget",
    description: "Cross-category budget reconciliation",
  },
  efficiency: {
    name: "Cost Efficiency Agent",
    icon: "🎯",
    color: "agent-efficiency",
    description: "Deterministic cost floor verification",
  },
};
